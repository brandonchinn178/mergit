{-|
Module      :  MergeBot.Core.GraphQL.PullRequestSimple
Maintainer  :  Brandon Chinn <brandon@leapyear.io>
Stability   :  experimental
Portability :  portable

Defines the PullRequestSimple graphql query.
-}
...
module MergeBot.Core.GraphQL.PullRequestSimple where
...
query :: Query Result
query = $(readGraphQLFile "PullRequestSimple.graphql") -- TODO: when generated, will actually be file contents
