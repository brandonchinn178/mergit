...
import Data.Aeson.Schema (Object, unwrap)
...
showType :: Type -> ExpQ
showType = \case
  AppT (ConT name) schema | name == ''Object -> [| "Object (" ++ $(showSchema schema) ++ ")" |]
  ty -> lift $ pprint ty

showSchema :: Type -> ExpQ
showSchema = appTypeE [| prettyShow |] . pure
